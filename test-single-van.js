...
if(data.length != 0) { 
	...
	let quanclass = singval.selected_quantity == 1 ? "hidden-quan" :  "";	
	...
	$('.summ-div-child').append('<div class="summ-extras-div"><div class="extras-text">'+singval.label+'<span class="extra-id" style="display:none">'+singval.id +'</span> <span class=extra-quant '+quanclass+'>x'+  singval.selected_quantity +' </span></div><div class="extras-pricing">'+extraprice+'</div></div>')
	})	
