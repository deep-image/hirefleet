...
$('.price-amount')[x].innerHTML =  '£' + $('#age').val() == '25' ? singval.price.base_price_with_taxes.amount.replace('.',',') : '£' +  (singval.price.base_price_with_taxes.amount + young_driver_cost).toFixed(2).replace('.',',');
...
//$('.price-amount')[x].innerHTML =  '£' +  agecheck ? 25 : 50;
